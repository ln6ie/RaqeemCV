...
export const translations: Record<Language, TranslationSet> = {
  en: {
    ...
    placeholders: {
      ...
      skills: 'e.g. AutoCAD (90%), MATLAB (85%), Leadership (80%) (add percentage inside brackets for bars)',
    ...
    tips: {
      ...
      skills: 'List technical and soft skills with optional percentages, e.g., AutoCAD (90%), to display progress bars in supporting templates',
  ...
  ar: {
    ...
    placeholders: {
      ...
      skills: 'مثال: برمجة (90%), تصميم (85%), قيادة (80%) (اكتب النسبة بين قوسين ليظهر شريط التقدم)',
    ...
    tips: {
      ...
      skills: 'اكتب المهارات مفصولة بفواصل، ويمكنك إضافة النسبة المئوية مثل: تصميم (90%) ليظهر شريط التقدم في قوالب السيرة الذاتية الداعمة',
