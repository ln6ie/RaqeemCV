...
export const Step3Export = () => {
  ...
  return (
    <>
      <PremiumCard title={t.steps.language} isDarkMode={isDarkMode} isRTL={isRTL}>
      ...
      <PremiumCard title={isRTL ? "تصدير السيرة الذاتية" : "Export CV"} isDarkMode={isDarkMode} isRTL={isRTL}>
